...
function WhatsAppButton({ cartItems }) {
  ...
  return (
    <a
      ...
      className="fixed bottom-4 right-4 bg-green-500 hover:bg-green-600 text-white w-14 h-14 rounded-full shadow-lg transition-all duration-300 flex items-center justify-center z-10 animate-pulse"
    >
