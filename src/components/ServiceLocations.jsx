...
function ServiceLocations() {
  ...
  return (
    <div className="flex w-50 items-center space-x-2 bg-white/80 backdrop-blur-sm rounded-lg px-2 py-2 shadow-sm">
      ...
      <div className="flex w-full flex-col p-1">
        ...
        <div className="flex flex-row w-full justify-between gap-2 mt-1">
          ...
          {locations.map((location, index) => (
            <span 
              key={index} 
              className="flex items-center px-2 py-0.5 rounded text-xs font-medium bg-indigo-100 text-indigo-800"
